...
-- Both options yield the same result, only purchases of product 4 because there are no purchases of product 9.
...
HINT: This query requires you to join two tables, use an aggregate function, and use the HAVING keyword. */
	...
	GROUP BY p.customer_id, c.customer_first_name, c.customer_last_name
